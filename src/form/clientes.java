...
public class clientes extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT d FROM Dadospessoais d");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                clientes.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                clientes.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                clientes.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                clientes.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<dao.Dadospessoais> toRemove = new ArrayList<dao.Dadospessoais>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            dao.Dadospessoais d = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(d);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        dao.Dadospessoais d = new dao.Dadospessoais();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<dao.Dadospessoais> merged = new ArrayList<dao.Dadospessoais>(list.size());
            for (dao.Dadospessoais d : list) {
    ...
    private java.util.List<dao.Dadospessoais> list;
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new clientes());
